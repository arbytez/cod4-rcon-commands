...
export const getInfo = async (
  ...
  const serverInfo: ServerInfo = {
    build: infoObj.build || '',
    clients: infoObj.clients || 0,
    ff: infoObj.ff || NaN,
    g_humanplayers: infoObj.g_humanplayers || 0,
    game: infoObj.game || '',
    ...
    mod: infoObj.mod || NaN,
    od: infoObj.od || NaN,
    protocol: infoObj.protocol || NaN,
    pswrd: infoObj.pswrd || '',
    pure: infoObj.pure || NaN,
    shortversion: infoObj.shortversion || '',
    sv_maxclients: infoObj.sv_maxclients || 0,
    type: infoObj.type || NaN,
    voice: infoObj.voice || NaN,
  };
...
export const getStatus = async (
  ...
  const serverStatus: ServerStatus = {
    ...
    sv_maxclients: statusObj.sv_maxclients || 0,
    uptime: statusObj.uptime || '',
    g_mapStartTime: mapStartDate ? mapStartDate : new Date(),
    sv_privateClients: statusObj.sv_privateClients || 0,
    ...
    g_compassShowEnemies: statusObj.g_compassShowEnemies || NaN,
    gamename: statusObj.gamename || '',
    protocol: statusObj.protocol || NaN,
    revision: statusObj.revision || '',
    shortversion: statusObj.shortversion || '',
    sv_disableClientConsole: statusObj.sv_disableClientConsole || NaN,
    sv_floodprotect: statusObj.sv_floodprotect || NaN,
    sv_maxPing: statusObj.sv_maxPing || NaN,
    sv_maxRate: statusObj.sv_maxRate || NaN,
    sv_minPing: statusObj.sv_minPing || NaN,
    sv_pure: statusObj.sv_pure || NaN,
    sv_voice: statusObj.sv_voice || NaN,
    type: statusObj.type || NaN,
  };
  return serverStatus;
};
